...
import static com.multiplesection.sks.imdbrevamp.HomePage.getHorizontalData;
import static com.multiplesection.sks.imdbrevamp.HomePage.getVerticalData;
...
public class MainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VERTICAL:
                view = inflater.inflate(R.layout.vertical_container_view, parent, false);
                holder = new VerticalViewHolder(view);
                break;
            case HORIZONTAL:
                view = inflater.inflate(R.layout.horizontal_container_view, parent, false);
